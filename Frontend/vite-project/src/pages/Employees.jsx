...
const Employees = () => {
  ...
  const { isAdmin } = useAuth();   // ← Yeh line important hai
  ...
  //         Only Admin managers can access employee management.
  //       </p>
  //     </div>
  //   );
  // }
      ...
      <Card className="dashboard-card">
        <CardContent className="p-4">
          <div className="flex flex-wrap items-center gap-4 mb-5">
            ...
            <div className="flex-1 min-w-full sm:min-w-[250px] md:min-w-[220px]">
            ...
            <Card key={employee.id} className="dashboard-card hover:shadow-card-hover transition-all duration-200">
              <CardContent className="p-6">
                ...
                <div className="flex items-start justify-between mb-4">
                  <div className="flex items-center space-x-3">
                    <Avatar className="w-12 h-12">
                      <AvatarImage
                        src={employee.profileImage || employee.avatar || `https://ui-avatars.com/api/?name=${encodeURIComponent(employee.name || "")}&background=3b82f6&color=fff`}
                        alt={employee.name}
                      />
                      <AvatarFallback>
                ...
                <div className="space-y-2 text-sm text-muted-foreground">
                  <div className="flex items-center space-x-2"><Mail className="w-4 h-4" /><span>{employee.email}</span></div>
                  <div className="flex items-center space-x-2"><Phone className="w-4 h-4" /><span>{employee.phone}</span></div>
                  <div className="flex items-center space-x-2"><Building2 className="w-4 h-4" /><span>{employee.department}</span></div>
                  <div className="flex items-center space-x-2"><DollarSign className="w-4 h-4" /><span>${(employee.salary ?? 0).toLocaleString()}/year</span></div>
                </div>
                ...
                <div className="flex space-x-2 mt-6">
                  ...
                  <Button variant="outline" size="sm" className="text-destructive hover:text-destructive" onClick={() => handleDeleteEmployee(employee.id)}>
                ...
                <TableRow key={employee.id}>
                  <TableCell>
                    <div className="flex items-center space-x-3">
                      <Avatar className="w-8 h-8">
                        <AvatarImage src={employee.profileImage || employee.avatar || `https://ui-avatars.com/api/?name=${encodeURIComponent(employee.name || "")}&background=3b82f6&color=fff`} />
                  ...
                  <TableCell>
                    <div className="flex space-x-2">
                      ...
                      <Button variant="ghost" size="sm" className="text-destructive" onClick={() => handleDeleteEmployee(employee.id)}>
                        <Trash2 className="w-4 h-4" />
                      </Button>
                    </div>
                  </TableCell>
          ...
          <div className="grid gap-6 py-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="space-y-2">
                ...
                <Input id="salary" type="number" value={newEmployee.salary} onChange={(e) => setNewEmployee({ ...newEmployee, salary: e.target.value })} placeholder="500000" />
              </div>
              <div className="space-y-2">
            ...
            <div className="space-y-2">
              ...
              <Input id="address" value={newEmployee.address} onChange={(e) => setNewEmployee({ ...newEmployee, address: e.target.value })} placeholder="Full address" />
            </div>
          </div>
      ...
      <Dialog open={!!editingEmployee} onOpenChange={(open) => !open && setEditingEmployee(null)}>
        <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
            ...
            <div className="grid gap-6 py-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input id="edit-salary" type="number" value={editingEmployee.salary} onChange={(e) => setEditingEmployee({ ...editingEmployee, salary: e.target.value })} />
                </div>
              </div>

              <div className="space-y-2">
                <Label htmlFor="edit-position">Position / Job Title</Label>
                <Input id="edit-position" value={editingEmployee.position ?? ""} onChange={(e) => setEditingEmployee({ ...editingEmployee, position: e.target.value })} />
              </div>
            </div>
          )}
          ...
          <div className="flex justify-end space-x-3 pt-4 border-t">
            ...
            <Button onClick={handleUpdateEmployee} className="btn-gradient">Update Employee</Button>
          </div>
        </DialogContent>
      </Dialog>
    </div>
